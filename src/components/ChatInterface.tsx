...
const ChatInterface = () => {
      ...
      <>
        <div className="fixed bottom-6 right-6 z-50">
          <Button
            ...
            className="w-14 h-14 rounded-xl bg-gradient-to-r from-neon-blue to-neon-purple hover:from-neon-cyan hover:to-neon-blue shadow-lg transition-all duration-300 relative overflow-hidden"
            size="lg"
          >
            <MessageSquare className="w-6 h-6 text-white z-10" />
            <div className="absolute inset-0 bg-neon-blue/30 rounded-xl animate-pulse"></div>
  ...
  return (
    <>
      <div className="fixed bottom-6 right-6 z-50">
        <div className="bg-gray-900/95 backdrop-blur-xl border border-gray-800/50 rounded-lg shadow-2xl w-80 h-96 flex flex-col">
          {/* Header */}
